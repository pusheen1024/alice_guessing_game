...
def handle_dialog(res, req):
    ...
    res['response']['buttons'] =  [{"title": "Помощь", "url": "https://canary-aquatic-handbell.glitch.me/information", "hide": False}]
    if req['session']['new']:
        ...
        if first_name is None:
            ...
            res['response']['buttons'].extend([{'title': 'Да', 'hide': True}, {'title': 'Нет', 'hide': True}])
